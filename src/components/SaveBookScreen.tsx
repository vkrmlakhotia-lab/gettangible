      ...
      <div className="max-w-md w-full h-full flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6">
          <div className="relative mb-8">
            <div
              className="w-28 rounded-lg overflow-hidden shadow-xl border border-border/30 bg-white"
              ...
              {coverUrl ? (
                <>
                  ...
                  <div className="absolute bottom-2.5 left-2.5 right-2.5">
                    {title && <p className="text-[8px] font-bold text-white tracking-wide leading-tight">{title}</p>}
                    {subtitle && <p className="text-[6px] text-white/70 mt-0.5">{subtitle}</p>}
                  </div>
                </>
              ) : (
            ...
            <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-20 h-2 bg-black/8 rounded-full blur-md" />
          </div>
        ...
        <div className="px-6 pb-8 pt-4 space-y-2.5">
          <button
            onClick={handleApple}
            className="w-full py-3.5 rounded-2xl bg-foreground text-background font-medium text-sm hover:opacity-90 transition-opacity flex items-center justify-center gap-2.5"
          >
          ...
          <button
            ...
            className="w-full py-3.5 rounded-2xl border border-border bg-card text-foreground font-medium text-sm hover:bg-muted/50 transition-colors flex items-center justify-center gap-2.5"
          >
